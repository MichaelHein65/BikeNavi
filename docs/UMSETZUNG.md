...
- Fahrtansicht mit GPS-Aufzeichnung, Pause/Fortsetzen/Beenden, lokalen Abbiegehinweisen, optionaler Sprachausgabe und Abweichungsanzeige. Der Tab „Fahren“ startet eine berechnete Planung direkt. Die Karte folgt der Fahrtrichtung, zeigt ungefähr 300 m voraus und verwendet die Belagsfarben auch bei Fahrten und gespeicherten Touren. Eine Live-Aktivität hält eine fahrtrichtungsorientierte Routengrafik mit Position, Abbiegestelle, Belagsfarben, Entfernung und verbleibender Strecke auf dem Sperrbildschirm aktuell; die Dynamic Island zeigt eine kompakte Fassung.
